...
define('PREFIX', 'PREFIX_'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
...
$config->theme = 'Hyper'; #default theme (header/footer combo) see 'Themes' folder for others and info
$config->style = ''; #currently only Bootswatch Theme uses style to switch look & feel
