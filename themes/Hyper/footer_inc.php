<!-- Footer Start -->
        ...
        <!-- bundle -->
        <script src="<?=THEME_PATH;?>assets/js/app.min.js"></script>

        <!-- third party js -->
        <script src="<?=THEME_PATH;?>assets/js/vendor/Chart.bundle.min.js"></script>
        <script src="<?=THEME_PATH;?>assets/js/vendor/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="<?=THEME_PATH;?>assets/js/vendor/jquery-jvectormap-world-mill-en.js"></script>
        <!-- third party js ends -->

        <!-- demo app -->
        <script src="<?=THEME_PATH;?>assets/js/pages/demo.dashboard.js"></script>
        <!-- end demo js-->
		
		<!--<script src="<?=THEME_PATH;?>assets/js/bootstrap.bundle.min.js"></script>-->
