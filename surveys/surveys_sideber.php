<?php //require '../inc_0700/config_inc.php'; #provides configuration, pathing, error handling, db credentials ?>
            ...
            <div class="left-side-menu left-side-menu-light">
                ...
                <div class="slimscroll-menu">
                    ...
                    <a href="index.html" class="logo text-center">
                        <span class="logo-lg">
                            <img src="<?=THEME_PATH;?>assets/images/logo-dark.png" alt="" height="16">
                        </span>
                        <span class="logo-sm">
                            <img src="<?=THEME_PATH;?>assets/images/logo_sm.png" alt="" height="16">
                        </span>
                    </a>
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                                    ...
                                    <div class="slimscroll" style="max-height: 230px;">
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="<?=THEME_PATH;?>assets/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="<?=THEME_PATH;?>assets/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span>
                                        <span class="account-user-name"><?php echo getAdminFirstName(1)?></span>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated topbar-dropdown-menu profile-dropdown">
                                    ...
                                    <!-- item-->
                                    <a href="<?php echo $config->adminLogout; ?>" class="dropdown-item notify-item">
